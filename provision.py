...
def main():
    ...
    print("  On your air conditioner / smart module:")
    print("  - Press and hold the WiFi/reset button until the LED blinks")
    print("  - Check your device manual for exact instructions")
    print()
